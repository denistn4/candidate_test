...
Сценарий: Работа со скачиванием

      Когда захожу на страницу "https://www.ruby-lang.org/ru/"
      И выбираю в меню "Скачать"
      И перехожу во вкладку меню "Скачать"
      И скачиваю оттуда последний стабильный релиз
      И проверяю, что файл находится в нужной директории
      И проверяю, что это имя скаченного файла совпадает с именем файла установщика, указанного на сайте
      И удаляю скаченый файл